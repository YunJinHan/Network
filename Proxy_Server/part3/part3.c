/*
    2012036901 윤 진 한
    컴퓨터공학과
    Computer Network - Project 2 < Part 3 >
    2016.11.06
*/
...
#define MAX_PTHREAD_CNT 1024

pthread_mutex_t mutex = PTHREAD_MUTEX_INITIALIZER; // initialize pthread.

pthread_t pthread_id[MAX_PTHREAD_CNT] = {0,};

// < Shared Data >
int pthread_number = 0; // pthread count.
...
void *pthreadStart(void *arg){
    ...
    int clientSockfd = *((int *)arg); // argument is clientSock File Descriptor.
    ...
    struct sockaddr_in endServ_addr;
    ...
    }// if reading data size = 0 , pthread exit.
...
int main(int argc, char *argv[]){
    ...
    int pthread_status; // when pthread exit , pthread return pthread_status.

    int clientSockfd, proxySockfd; //descriptors rturn from socket and accept system calls
    int portno; // port number
    
    socklen_t clilen; 
    /*sockaddr_in: Structure Containing an Internet Address*/
    struct sockaddr_in cli_addr, proxy_addr;
    ...
    bzero(cacheTime, CACHE_COUNT*BUFFER_SIZE);
    // initialize caching array.

    while (1){

        if (pthread_number == MAX_PTHREAD_CNT) pthread_number = 0;
        // if pthread_number is over MAX_PTHREAD_CNT , pthread_number initailize 0.
        printf("==============================================================\n");
        printf("====================  Waiting for Client  ====================\n");
        printf("==================  < %3d thread waiting >  ==================\n",pthread_number);
        printf("==============================================================\n");
        /*accept function: 
        ...
        */
        ...
        if (pthread_create(&pthread_id[pthread_number],NULL,pthreadStart,(void *)&clientSockfd)) error("ERROR on creating pthread");
        // pthread create.
        
        pthread_join(pthread_id[pthread_number],(void **)&pthread_status);
        // pthread waiting utill exiting.
        
        printf("==============================================================\n");
        printf("==================  < %3d thread Ending >  ===================\n",pthread_number);
